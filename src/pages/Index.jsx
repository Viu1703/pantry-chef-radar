...
const Index = () => {
  ...
  const [activeIngredientFilters, setActiveIngredientFilters] = useState([]);
  ...
  const handleAddIngredientFilter = (ingredient) => {
  ...
  const handleRemoveIngredientFilter = (ingredient) => {
